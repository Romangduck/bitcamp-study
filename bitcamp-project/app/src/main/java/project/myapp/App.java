...
public class App {
  ...
  public static void main(String[] args) {
    ...
    Handler memberHandler = new MemberHandler(prompt, "대상자 정보");
    Handler boardHandler = new BoardHandler(prompt, "자유게시판");
    Handler complaintHandler = new BoardHandler(prompt, "민원");
