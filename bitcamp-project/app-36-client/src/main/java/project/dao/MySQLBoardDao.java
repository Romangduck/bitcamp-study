...
public class MySQLBoardDao implements BoardDao {
  ...
  public List<Board> list() {
    try (Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery(
            "select board_no, title, writer, view_count, created_date" + " from project_board"
    ...
    try (Statement stmt = con.createStatement();
        ResultSet rs =
            stmt.executeQuery("select board_no, title, content, writer, view_count, created_date"
                + " from project_board" + " where category=" + this.category + " and board_no=" + no
  ...
  public int update(Board board) {
    try (Statement stmt = con.createStatement()) {
      ...
      return stmt.executeUpdate(String.format(
          "update project_board set" + " title='%s'," + " content='%s'"
  ...
  public int delete(Board board) {
    try (Statement stmt = con.createStatement()) {
      ...
      return stmt.executeUpdate(String.format(
          "delete from project_board where category=%d and board_no=%d and password='%s'",
