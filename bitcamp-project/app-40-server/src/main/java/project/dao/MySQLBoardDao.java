...
public class MySQLBoardDao implements BoardDao {
  ...
  /*
   * select b.board_no, b.title, b.view_count, b.created_date, m.member_no, m.name from
   * project_board b inner join project_member m on b.writer=m.member_no where category=1 order by
   * board_no desc
   */
  @Override
