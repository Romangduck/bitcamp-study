...
<div style='height:50px;background-color:orange;'>
    ...
    <a href='/board/list.jsp?category=1'>자유게시판</a>
    <a href='/board/list.jsp?category=2'>의사종합의견</a>
    <a href='/board/list.jsp?category=3'>진료예약</a>
...
<c:choose>
    ...
    <c:otherwise>
        ...
        <c:if test="${not empty sessionScope.loginUser.photo}">
            <img src='http://bnpxdrusesip19010743.cdn.ntruss.com/member/${loginUser.photo}?type=f&w=30&h=40&faceopt=true&ttype=jpg'>
        </c:if>
