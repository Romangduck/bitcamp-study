...
public class HeaderServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<a href='/board/list?category=1'>의사 종합 의견</a>");
        out.println("<a href='/board/list?category=2'>자유 게시판</a>");
        out.println("<a href='/board/list?category=3'>진료 예약 게시판</a>");
        ...
        if (loginUser == null) {
            ...
            out.printf("%s %s <a href='/auth/logout'>로그아웃</a>\n",
                    (loginUser.getPhoto() == null ?
                            ...
                            String.format("<img src='http://bnpxdrusesip19010743.cdn.ntruss.com/member/%s?type=f&w=30&h=40&faceopt=true&ttype=jpg'>",
                                    loginUser.getPhoto())),
                    loginUser.getName());
        }
