...
insert into project_board(board_no, title, content, writer, password, category)
  values(11, '홍길동', '답이없음', 1, sha1('1111'), 1);
insert into project_board(board_no, title, content, writer, password, category)
  values(12, '홍길덕', '답이없음', 1, sha1('1111'), 1);
insert into project_board(board_no, title, content, writer, password, category)
  values(13, '홍길덩', '성실함', 1, sha1('1111'), 1);
insert into project_board(board_no, title, content, writer, password, category)
  values(14, '홍길둥', '우등생', 1, sha1('1111'), 1);
insert into project_board(board_no, title, content, writer, password, category)
  values(15, '맞짱뜰사람구함', '구라임', 2, sha1('1111'), 2);
insert into project_board(board_no, title, content, writer, password, category)
  values(16, '사실 너 좋아해', '거울을보며...', 3, sha1('1111'), 2);
insert into project_board(board_no, title, content, writer, password, category)
  values(19, '앗', '뜨거', 4, sha1('1111'), 3);
insert into project_board(board_no, title, content, writer, password, category)
  values(20, '독서', '감동적이다', 5, sha1('1111'), 3);
insert into project_board(board_no, title, content, writer, password, category)
  values(21, '부모님 일 도와드리기', '너무 좋았다', 6, sha1('1111'), 3);
insert into project_board(board_no, title, content, writer, password, category)
  values(22, '대나무헬리콥터만들기', '재밌었다', 6, sha1('1111'), 3);