              ...
              <form action='/member/update.jsp' method='post' enctype='multipart/form-data'>
                <table border='1'>
                    ...
                    <td style='width:300px;'>
                      ...
                      %>
                       ...
                       %>
                        ...
                        <a href='https://kr.object.ncloudstorage.com/bitcamp-nc7-bucket-24/member/<%=member.getPhoto()%>'>
                        <img src='http://bnpxdrusesip19010743.cdn.ntruss.com/member/<%=member.getPhoto()%>?type=f&w=60&h=80&faceopt=true&ttype=jpg'>
                        </a>
                  ...
                  <tr>
                    ...
                    <td style='width:300px;'><input type='text' name='no' value='<%=member.getNo()%>' readonly></td>
                  </tr>
                  <tr>
                    <th>이름</th>
                  ...
                  <tr>
                    ...
                    <td><select name='gender'>
                        ...
                        <option value='W' <%=member.getGender()=='W' ? "selected" : "" %>>여자</option>
                      </select></td>
                  </tr>
                </table>
                <div>
