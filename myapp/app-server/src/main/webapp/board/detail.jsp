    ...
    <%@ page import="bitcamp.myapp.vo.AttachedFile" %>
      <%@ page import="bitcamp.myapp.vo.Board" %>
        ...
        <%-- Board board=boardDao.findBy( Integer.parseInt(request.getParameter("category")),
          Integer.parseInt(request.getParameter("no"))); pageContext.setAttribute("board", board); --%>
          <!DOCTYPE html>
          <html>
          ...
          <body>
            ...
            <c:if test="${not empty board}">
                  ...
                  <tr>
                    ...
                    <td>
                      <c:forEach items="${board.getAttachedFiles()}" var="file">
                        <a
                          href='https://kr.object.ncloudstorage.com/bitcamp-nc7-bucket-118/board/${file.filePath}'>${file.filePath}</a>
              ...
              <% try { //board.setViewCount(board.getViewCount() + 1); //boardDao.updateCount(board);
                //sqlSessionFactory.openSession(false).commit(); } catch (Exception e) {
