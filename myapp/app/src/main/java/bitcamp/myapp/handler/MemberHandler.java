...
public class MemberHandler {
  ...
  public static void inputMember() {
    ...
    name1[length] = Prompt.inputString("이름?");
    email1[length] = Prompt.inputString("이메일?");
    password1[length] = Prompt.inputString("암호?");
    ...
    loop: while (true) {
      ...
      Prompt.scanner.nextLine(); // 입력 값을 읽고 난 후에 남아 있는 줄바꿈 코드를 제거한다.
